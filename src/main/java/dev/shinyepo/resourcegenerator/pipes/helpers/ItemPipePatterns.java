...
import static dev.shinyepo.resourcegenerator.pipes.helpers.ItemPipeConnection.NONE;

public class ItemPipePatterns {
    ...
    public static QuadSetting findPattern(ItemPipeConnection s1, ItemPipeConnection s2, ItemPipeConnection s3, ItemPipeConnection s4) {
