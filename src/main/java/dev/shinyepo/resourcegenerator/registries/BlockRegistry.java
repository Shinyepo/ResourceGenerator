...
public class BlockRegistry {
    ...
    public static final DeferredBlock<Block> ITEM_PIPE = BLOCKS.registerBlock("item_pipe", ItemPipe::new, BlockBehaviour.Properties::of);
    ...
    public static final DeferredBlock<Block> SPAWNER_ABSORBER = BLOCKS.registerBlock("spawner_absorber", SpawnerAbsorber::new, BlockBehaviour.Properties::of);
